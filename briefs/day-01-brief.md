...
[Course Home](../README.md) | [Next: Day 2 - Setting Up Your First Scene →](./day-02-brief.md)
...
The web has evolved from static documents to interactive applications. 3D graphics are the next frontier, enabling experiences that were previously only possible in native apps or game engines. Here's why this matters:
...
**Integration**: 3D can seamlessly integrate with HTML, CSS, and JavaScript. You can overlay UI elements on 3D scenes, respond to DOM events, and use the entire web platform ecosystem.
...
**2. Camera**: This defines what the viewer sees. Just like in filmmaking, you can have different camera types: perspective cameras (realistic depth perception, objects farther away look smaller) or orthographic cameras (no perspective distortion, used for technical drawings or 2D-style games). The camera's position and orientation determine the viewpoint.
...
- **Data Visualization**: Complex datasets rendered in 3D space (GitHub's contribution graphs)
...
```javascript
// Conceptual example - don't type this yet
// This shows the core pattern of every Three.js app
...
**Expected Output:**
Understanding of where to find information when you need it. The Three.js docs are well-organized by category (Core, Cameras, Lights, etc.).
...
**Tomorrow:** [Day 2: Setting Up Your First Three.js Scene](./day-02-brief.md) — Create your first rotating cube and understand the scene graph
